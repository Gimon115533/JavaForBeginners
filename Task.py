...
class Search(unittest.TestCase):
    ...
    def test_search(self):
        ...
        spisok = self.drv.find_element_by_xpath('//*[@id="rso"]/div[1]/div/div/div/div/div[1]/a/div/cite')
        ...
        spisok2 = self.drv.find_element_by_xpath('//*[@id="rso"]/div[1]/div/div/div/div/div[1]/a/div/cite')
